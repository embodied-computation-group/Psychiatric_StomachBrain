...
PLVXVoxelFilename = [global_path2root,'subject',sprintf('%.4d',subj_idx),filesep,'Timeseries',filesep,...
    'MRItimeseries',filesep,cfgMain.task,filesep,'PLVxVoxel']; % output filename
