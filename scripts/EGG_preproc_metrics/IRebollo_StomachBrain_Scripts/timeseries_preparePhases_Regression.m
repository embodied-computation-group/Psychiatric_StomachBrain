...
BOLDTimeseriesFilename = [global_path2root,'subject',sprintf('%.4d',subj_idx),filesep,'Timeseries',filesep,...
...
EGGPhaseXVolumeFilename = ['/Users/au704655/Documents/EGG/StomachBrain_2021/STOMACH_BRAIN/VMP/'...
...
% Output
BOLDPhasesTimeseriesFilename = [global_path2root,'subject',sprintf('%.4d',subj_idx),filesep,'Timeseries',filesep,...
    'MRItimeseries',filesep,cfgMain.task,filesep,'BOLD_filtered_fullband_CSFWMREGRESSED_phases']; 
...
filteredMRI=tools_bpFilter(timeseries.error_csf_wm_z,sr,filterOrder,...
...
%     voxelCoordinates = sub2ind([79,95,79],9,45,53); % voxel in somatomotor cortex
    ...
    hold on
    subplot(3,1,1)
    plot(timeseries.error_csf_wm_z(:,ind_voxelCoordinates_inside),'r','LineWidth',2)
